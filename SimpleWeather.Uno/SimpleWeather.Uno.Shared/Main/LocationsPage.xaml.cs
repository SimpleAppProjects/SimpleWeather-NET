...
namespace SimpleWeather.UWP.Main
{
    ...
    public sealed partial class LocationsPage : ViewModelPage, ICommandBarPage, ISnackbarPage
    {
        ...
        private async void SwipeItem_Invoked(
#if HAS_UNO
            SwipeItem sender, SwipeItemInvokedEventArgs args
#else
            Microsoft.UI.Xaml.Controls.SwipeItem sender, Microsoft.UI.Xaml.Controls.SwipeItemInvokedEventArgs args
#endif
        )
        {
