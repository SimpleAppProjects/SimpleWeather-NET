...
namespace SimpleWeather.NET.Helpers
{
    ...
    {
        public static T FindChild<T>(this FrameworkElement depObj, String Name = null, bool includeParent = false) where T : FrameworkElement
        {
        ...
        public static T GetParent<T>(this FrameworkElement depObj) where T : FrameworkElement
        {
            if (depObj != null)
            {
