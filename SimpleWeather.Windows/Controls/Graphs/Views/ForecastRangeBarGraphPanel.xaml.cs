...
{
    public sealed partial class ForecastRangeBarGraphPanel : UserControl
    {
        //
        // Summary:
        ...
        public static readonly DependencyProperty CanScrollToStartProperty =
            ...
            typeof(ForecastRangeBarGraphPanel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty ForecastDataProperty =
            DependencyProperty.Register(nameof(ForecastData), typeof(ForecastRangeBarGraphData),
            typeof(ForecastRangeBarGraphPanel), new PropertyMetadata(null, (o, e) => (o as ForecastRangeBarGraphPanel)?.UpdateView(false)));
