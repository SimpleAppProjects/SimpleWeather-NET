...
{
    public partial class OWMRadarViewProvider
    {
        ...
        private readonly Lazy<HttpClient> httpClientLazy = new(() =>
        {
            ...
            var CacheRoot = System.IO.Path.Combine(
                ...
                "TileCache", "OpenWeatherMap");
#else
            var CacheRoot = System.IO.Path.Combine(ApplicationDataHelper.GetLocalCacheFolderPath(), "TileCache", "OpenWeatherMap");
#endif
