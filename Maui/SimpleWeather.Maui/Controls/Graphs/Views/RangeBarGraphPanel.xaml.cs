...
namespace SimpleWeather.Maui.Controls.Graphs
{
    public sealed partial class RangeBarGraphPanel : ContentView, IGraphPanel
    {
        ...
        public static readonly BindableProperty CanScrollToStartProperty =
            ...
            typeof(RangeBarGraphPanel), false);
        ...
        public static readonly BindableProperty ForecastDataProperty =
            BindableProperty.Create(nameof(ForecastData), typeof(RangeBarGraphData),
            typeof(RangeBarGraphPanel), null, propertyChanged: (o, _, _) => (o as RangeBarGraphPanel)?.UpdateView(false));
