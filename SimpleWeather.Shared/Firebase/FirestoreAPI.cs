        ...
        public class DatabasesResource
        {
            ...
            public class CollectionGroupsResource
            {
                ...
                public class FieldsResource
                {
                    ...
                    public class PatchRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.GoogleLongrunningOperation>
                    {
                        ...
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.GoogleFirestoreAdminV1Field body, string name) : base(service)
                        {
                            Name = name;
                            Body = body;
                            InitParameters();
                ...
                public class IndexesResource
                {
                    ...
                    public class CreateRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.GoogleLongrunningOperation>
                    {
                        ...
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.GoogleFirestoreAdminV1Index body, string parent) : base(service)
                        {
                            Parent = parent;
                            Body = body;
                            InitParameters();
            ...
            public class DocumentsResource
            {
                ...
                public class BatchGetRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.BatchGetDocumentsResponse>
                {
                    ...
                    public BatchGetRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.BatchGetDocumentsRequest body, string database) : base(service)
                    {
                        Database = database;
                        Body = body;
                        InitParameters();
                ...
                /// Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`.
                /// </param>
                public virtual BatchWriteRequest BatchWrite(Google.Apis.Firestore.v1fix.Data.BatchWriteRequest body, string database)
                {
                ...
                /// each write. If you require an atomically applied set of writes, use Commit instead.
                /// </summary>
                public class BatchWriteRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.BatchWriteResponse>
                {
                    /// <summary>Constructs a new BatchWrite request.</summary>
                    public BatchWriteRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.BatchWriteRequest body, string database) : base(service)
                    {
                        Database = database;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Firestore.v1fix.Data.BatchWriteRequest Body { get; set; }
                ...
                public class BeginTransactionRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.BeginTransactionResponse>
                {
                    ...
                    public BeginTransactionRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.BeginTransactionRequest body, string database) : base(service)
                    {
                        Database = database;
                        Body = body;
                        InitParameters();
                ...
                public class CommitRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.CommitResponse>
                {
                    ...
                    public CommitRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.CommitRequest body, string database) : base(service)
                    {
                        Database = database;
                        Body = body;
                        InitParameters();
                ...
                public class CreateDocumentRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.Document>
                {
                    ...
                    public CreateDocumentRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.Document body, string parent, string collectionId) : base(service)
                    {
                        Parent = parent;
                ...
                public class ListCollectionIdsRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.ListCollectionIdsResponse>
                {
                    ...
                    public ListCollectionIdsRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.ListCollectionIdsRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                ...
                public class ListenRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.ListenResponse>
                {
                    ...
                    public ListenRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.ListenRequest body, string database) : base(service)
                    {
                        Database = database;
                        Body = body;
                        InitParameters();
                ...
                /// </param>
                public virtual PartitionQueryRequest PartitionQuery(Google.Apis.Firestore.v1fix.Data.PartitionQueryRequest body, string parent)
                {
                ...
                /// the query results.
                /// </summary>
                public class PartitionQueryRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.PartitionQueryResponse>
                {
                    /// <summary>Constructs a new PartitionQuery request.</summary>
                    public PartitionQueryRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.PartitionQueryRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.Firestore.v1fix.Data.PartitionQueryRequest Body { get; set; }
                ...
                {
                    /// <summary>Constructs a new Patch request.</summary>
                    public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.Document body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
                ...
                public class RollbackRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.Empty>
                {
                    ...
                    public RollbackRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.RollbackRequest body, string database) : base(service)
                    {
                        Database = database;
                        Body = body;
                        InitParameters();
                ...
                public class RunQueryRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.RunQueryResponse>
                {
                    ...
                    public RunQueryRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.RunQueryRequest body, string parent) : base(service)
                    {
                        Parent = parent;
                        Body = body;
                        InitParameters();
                ...
                public class WriteRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.WriteResponse>
                {
                    ...
                    public WriteRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.WriteRequest body, string database) : base(service)
                    {
                        Database = database;
                        Body = body;
                        InitParameters();
            ...
            public class OperationsResource
            {
                ...
                public class CancelRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.Empty>
                {
                    ...
                    public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.GoogleLongrunningCancelOperationRequest body, string name) : base(service)
                    {
                        Name = name;
                        Body = body;
                        InitParameters();
            ...
            public class ExportDocumentsRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.GoogleLongrunningOperation>
            {
                ...
                public ExportDocumentsRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.GoogleFirestoreAdminV1ExportDocumentsRequest body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
            ...
            /// <summary>Gets information about a database.</summary>
            public class GetRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.GoogleFirestoreAdminV1Database>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name) : base(service)
                {
            ...
            public class ImportDocumentsRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.GoogleLongrunningOperation>
            {
                ...
                public ImportDocumentsRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.GoogleFirestoreAdminV1ImportDocumentsRequest body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
            ...
            /// <summary>List all the databases in the project.</summary>
            public class ListRequest : FirestoreBaseServiceRequest<Google.Apis.Firestore.v1fix.Data.GoogleFirestoreAdminV1ListDatabasesResponse>
            {
                /// <summary>Constructs a new List request.</summary>
                public ListRequest(Google.Apis.Services.IClientService service, string parent) : base(service)
                {
            ...
            /// </param>
            public virtual PatchRequest Patch(Google.Apis.Firestore.v1fix.Data.GoogleFirestoreAdminV1Database body, string name)
            {
                return new PatchRequest(service, body, name);
            }
            ...
            {
                /// <summary>Constructs a new Patch request.</summary>
                public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Firestore.v1fix.Data.GoogleFirestoreAdminV1Database body, string name) : base(service)
                {
                    Name = name;
                    Body = body;
                    InitParameters();
                ...
                /// <summary>Gets or sets the body of this request.</summary>
                Google.Apis.Firestore.v1fix.Data.GoogleFirestoreAdminV1Database Body { get; set; }
