...
namespace SimpleWeather.Controls
{
    ...
    public class DetailItemViewModel
    {
        ...
        public DetailItemViewModel(Beaufort.BeaufortScale beaufortScale)
        {
            ...
            switch (beaufortScale)
            {
                case Beaufort.BeaufortScale.B0:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_0;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_0");
                    break;

                case Beaufort.BeaufortScale.B1:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_1;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_1");
                    break;

                case Beaufort.BeaufortScale.B2:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_2;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_2");
                    break;

                case Beaufort.BeaufortScale.B3:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_3;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_3");
                    break;

                case Beaufort.BeaufortScale.B4:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_4;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_4");
                    break;

                case Beaufort.BeaufortScale.B5:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_5;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_5");
                    break;

                case Beaufort.BeaufortScale.B6:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_6;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_6");
                    break;

                case Beaufort.BeaufortScale.B7:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_7;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_7");
                    break;

                case Beaufort.BeaufortScale.B8:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_8;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_8");
                    break;

                case Beaufort.BeaufortScale.B9:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_9;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_9");
                    break;

                case Beaufort.BeaufortScale.B10:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_10;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_10");
                    break;

                case Beaufort.BeaufortScale.B11:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_11;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_11");
                    break;

                case Beaufort.BeaufortScale.B12:
                    this.Icon = WeatherIcons.WIND_BEAUFORT_12;
                    this.Value = SimpleLibrary.ResLoader.GetString("/Beaufort/Beaufort_12");
                    break;
            }
        }
        ...
        public DetailItemViewModel(UV uv)
        {
            ...
            if (uv.index < 3)
            {
                this.Value = SimpleLibrary.ResLoader.GetString("/UVIndex/UV_0");
            }
            else if (uv.index < 6)
            {
                this.Value = SimpleLibrary.ResLoader.GetString("/UVIndex/UV_3");
            }
            else if (uv.index < 8)
            {
                this.Value = SimpleLibrary.ResLoader.GetString("/UVIndex/UV_6");
            }
            else if (uv.index < 11)
            {
                this.Value = SimpleLibrary.ResLoader.GetString("/UVIndex/UV_8");
            }
            else if (uv.index >= 11)
            {
                this.Value = SimpleLibrary.ResLoader.GetString("/UVIndex/UV_11");
            }
        }
        ...
        public DetailItemViewModel(AirQuality aqi)
        {
            ...
            if (aqi.index < 51)
            {
                this.Value = SimpleLibrary.ResLoader.GetString("/AQIndex/AQI_Level_0_50");
            }
            else if (aqi.index < 101)
            {
                this.Value = SimpleLibrary.ResLoader.GetString("/AQIndex/AQI_Level_51_100");
            }
            else if (aqi.index < 151)
            {
                this.Value = SimpleLibrary.ResLoader.GetString("/AQIndex/AQI_Level_101_150");
            }
            else if (aqi.index < 201)
            {
                this.Value = SimpleLibrary.ResLoader.GetString("/AQIndex/AQI_Level_151_200");
            }
            else if (aqi.index < 301)
            {
                this.Value = SimpleLibrary.ResLoader.GetString("/AQIndex/AQI_Level_201_300");
            }
            else if (aqi.index >= 301)
            {
                this.Value = SimpleLibrary.ResLoader.GetString("/AQIndex/AQI_Level_300");
            }
        }
    }
}