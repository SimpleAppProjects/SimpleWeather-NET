...
using System.Text;
using SimpleWeather.Utf8JsonGen.Resolvers.Internal;
...
namespace SimpleWeather.Utf8JsonGen.Resolvers.Internal
{
    internal sealed class EnumByValueResolver : Utf8Json.IJsonFormatterResolver
    {
        ...
        static class FormatterCache<T>
        {
            ...
            static FormatterCache()
            {
                ...
                {
                    formatter = (Utf8Json.IJsonFormatter<T>)(object)new SimpleWeather.Utf8JsonGen.Formatters.EnumFormatter<T>();
                }
            }
        }
    }
