...
namespace SupportWidgetXF.Droid.Renderers.DropCombo
{
    ...
    public class DropItemAdapter : ArrayAdapter, IFilterable
    {
        ...
        public override Android.Views.View GetView(int position, Android.Views.View convertView, ViewGroup parent)
        {
            ...
            Android.Widget.Button bttClick;
            ...
            bttClick = convertView.FindViewById<Android.Widget.Button>(Resource.Id.bttClick);
            ...
            if (txtDescription != null)
            {
                ...
                txtDescription.SetTextColor(ConfigStyle.DescriptionTextColor.ToPlatform());
            }
            txtSeperator.SetBackgroundColor(ConfigStyle.SeperatorColor.ToPlatform());
