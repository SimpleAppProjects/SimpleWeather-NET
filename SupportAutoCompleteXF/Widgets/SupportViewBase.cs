namespace SupportWidgetXF.Widgets
{
    public class SupportViewBase : View
    {
        ...
        public static readonly BindableProperty CornerColorProperty = BindableProperty.Create("CornerColor", typeof(Color), typeof(SupportViewBase), default);
        ...
        public static readonly BindableProperty FontFamilyProperty = BindableProperty.Create("FontFamily", typeof(string), typeof(SupportViewBase), "");
